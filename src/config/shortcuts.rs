...
pub fn default_shortcut_map() -> ShortcutMap {
    ...
    map.insert(
        "Logo+Shift+Space".into(),
        ShortcutActionConfig::OpenDefault {
            open_default: OpenDefaultConfig::Role("file_manager".into()),
        },
    );
    map.insert(
        "Logo+Shift+B".into(),
    ...
    map.insert(
        "Logo+Shift+M".into(),
        ShortcutActionConfig::BuiltinName("ScaleDown".into()),
    );
    map.insert(
        "Logo+Shift+P".into(),
        ShortcutActionConfig::BuiltinName("ScaleUp".into()),
    );
    map.insert(
        "Logo+Shift+R".into(),
        ShortcutActionConfig::BuiltinName("RotateOutput".into()),
    );
    map.insert(
        "Logo+Shift+I".into(),
        ShortcutActionConfig::BuiltinName("RunLayersDebug".into()),
    );
    map.insert(
        "Alt+Tab".into(),
        ShortcutActionConfig::BuiltinName("ApplicationSwitchNext".into()),
    );
    map.insert(
        "Alt+Shift+Tab".into(),
        ShortcutActionConfig::BuiltinName("ApplicationSwitchPrev".into()),
    );
    map.insert(
        "Alt+R".into(),
        ShortcutActionConfig::BuiltinName("ApplicationSwitchNextWindow".into()),
    );
    map.insert(
        "Alt+W".into(),
    ...
    map.insert(
        "Alt+D".into(),
        ShortcutActionConfig::BuiltinName("ExposeShowDesktop".into()),
    );
    map.insert(
        "Alt+F".into(),
        ShortcutActionConfig::BuiltinName("ExposeShowAll".into()),
    );
    map.insert(
        "Alt+J".into(),
        ShortcutActionConfig::BuiltinName("SceneSnapshot".into()),
    );
    map
}
