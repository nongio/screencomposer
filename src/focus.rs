...
impl<BackendData: Backend> PointerTarget<ScreenComposer<BackendData>> for FocusTarget {
    fn enter(
        &self,
...
impl<BackendData: Backend> KeyboardTarget<ScreenComposer<BackendData>> for FocusTarget {
    fn enter(
        &self,
        seat: &Seat<ScreenComposer<BackendData>>,
        data: &mut ScreenComposer<BackendData>,
